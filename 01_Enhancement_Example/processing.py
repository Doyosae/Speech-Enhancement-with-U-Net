...
class dataProcessing (fixedLength):
    ...
    def __init__ (self, sr = 16000, n_fft = 512, n_mfcc = 40, hop_length = 512):
        ...
        super().__init__ (sr = 16000, sliceCut1 = 744, sliceCut2 = 930)
        """
        부모 클래스에서 초기값들을 받아옴
        ...
        Check size of loadedCallDataList (4,)
        Check the element size of loadedCallDataList, respectively
        trainLabel : (720, 33856)
        testLabel  : (210, 33856)
        trainData  : (720, 33856)
        testData   : (210, 33856)
        """
    ...
    def stft (self):
        ...
        1. 타입은 numpy.complex64
        2. n_fft 값에 따라 반환 값의 행, 열 사이즈가 달라짐
        고정 길이 시퀀스로 slice한 데이터 입력 사이즈 33856에서
        n_fft = 2048 -> (1025, 89)
        n_fft = 1024 -> (513, 177)
        n_fft = 512 -> (257, 353)
        """
