...
class TrainUnet ():
    ...
    def __init__ (self):
        ...
        self.real_turple, self.imag_turple = self.return_data()
    ...
    def return_data (self):
        ...
        phase_train_data = get_imagData(train_data, self.train_length, image_width, image_height)
        phase_train_label = get_imagData(train_label, self.train_length, image_width, image_height)
        phase_test_data = get_imagData(test_data, self.test_length, image_width, image_height)
        phase_test_label = get_imagData(test_label, self.test_length, image_width, image_height)
        
        real_turple = (train_data, train_label, test_data, test_label)
        imag_turple = (phase_train_data, phase_train_label, phase_test_data, phase_test_label)
        
        print("Getting data complete")
        
        # Return type is turple
        return real_turple, imag_turple
    
    def unzip_real(self):
        
        train_data, train_label, test_data, test_label = self.real_turple
    ...
    def unzip_imag(self):
        ...
        phase_train_data, phase_train_label, phase_test_data, phase_test_label = self.imag_turple
        
        return phase_train_data, phase_train_label, phase_test_data, phase_test_label
    ...
    def train(self):
        ...
        model.save("./save/Unet5_dice_loss.h5")
